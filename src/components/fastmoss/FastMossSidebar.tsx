...
export function FastMossSidebar() {
  ...
  return (
    <aside className="fixed left-0 top-0 z-40 h-screen w-64 bg-sidebar border-r border-sidebar-border flex flex-col">
      ...
      <div className="flex h-16 items-center gap-2 px-4 border-b border-sidebar-border shrink-0">
        <div className="flex h-9 w-9 items-center justify-center rounded-lg bg-tiktok">
          <Zap className="h-5 w-5 text-white" />
        </div>
        <span className="text-xl font-bold text-sidebar-foreground">FastMoss</span>
        <Badge variant="outline" className="ml-auto text-xs border-tiktok text-tiktok">
          Brasil
        </Badge>
      </div>
                      ...
                      <Link
                        ...
                        className={cn(
                          ...
                          location.pathname === child.href
                            ? "bg-sidebar-accent text-tiktok font-medium"
